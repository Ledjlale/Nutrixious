...
#ifndef DATABASE_EXERCISE_UNIT_PROXY_MODEL_H
#define DATABASE_EXERCISE_UNIT_PROXY_MODEL_H

#include "src/tool/proxyModel/SortFilterProxyModel.hpp"

class ExerciseUnitProxyModel: public SortFilterProxyModel {
Q_OBJECT
	Q_PROPERTY(QVariantList exercises READ getExercises WRITE setExercises NOTIFY exercisesChanged)
public:
	ExerciseUnitProxyModel(QObject * parent = nullptr);
