...
#ifndef BASE_SERIE_LIST_MODEL_H
#define BASE_SERIE_LIST_MODEL_H

#include "src/tool/proxyModel/ProxyAbstractListModel.hpp"
#include "SerieModel.h"

namespace Base{
class SerieListModel: public ProxyAbstractListModel<SerieModel*> {
Q_OBJECT
public:
	SerieListModel(QObject * parent = nullptr);
	SerieListModel(QVariantList exercises, QObject * parent);
