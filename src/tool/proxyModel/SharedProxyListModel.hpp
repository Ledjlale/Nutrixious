...
class SharedProxyListModel : public ProxyAbstractListModel<QSharedPointer<QObject>> {
	Q_OBJECT
	
public:
	Q_PROPERTY(int count READ getCount NOTIFY countChanged)
	SharedProxyListModel (QObject *parent = Q_NULLPTR);
	virtual ~SharedProxyListModel();
